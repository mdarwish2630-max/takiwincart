    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 text-center">
            <div class="card lg:p-6 p-4">
                ...
                <h3 class="text-lg font-medium mb-2">{{ $themeSettings['service_title'] ?? __('Instant Delivery') }}</h3>
                <p class="text-gray-600">{{ $themeSettings['service_content'] ?? __('Get your digital products immediately after purchase') }}</p>
            </div>
        </div>
    </div>
</section>
