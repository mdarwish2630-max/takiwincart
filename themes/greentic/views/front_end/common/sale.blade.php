...
<section class="lg:py-20 py-10 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="bg-cover bg-center lg:py-20 lg:px-10 sm:p-6 px-4 py-8 rounded-2xl sm:bg-center bg-left" style="background-image:url('{{ get_file( $themeSettings['more_offer_image'] ?? 'themes/greentic/assets/images/offer-banner.png')}}');">
            <div class="lg:max-w-lg md:max-w-md max-w-sm">
                <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold md:mb-4 mb-2">{{ $themeSettings['more_offer_big_text'] ?? __('Special Digital Offer!') }}</h2>
