<div id="search-popup-container" class="fixed flex items-center justify-center inset-0 z-20 hidden">
    ...
    <div class="relative mb-6">
        <input type="text" id="search-input" placeholder="{{ __('What are you looking for?') }}" class="w-full form-input pe-10" />
        <button type="button" class="absolute ltr:right-4 rtl:left-4  top-3 flex">
        <i class="fas fa-search text-gray-400"></i>
        </button>
    </div>
    <button class="w-full btn-primary">{{ __('Search Now') }}</button>
</form>
    </div>
</div>
