...
function rmdrp() {
  ...
  if (document.querySelector(".dash-header:not(.dash-mob-header) .dash-md-overlay")) {
    document
...
function rmmenu() {
  ...
  if (document.querySelector(".dash-sidebar .dash-menu-overlay")) {
...
for (var t = 0; t < tc.length; t++) {
  ...
  prodlike.addEventListener("change", function (event) {
    if (event.currentTarget.checked) {
      ...
      setTimeout(function () {
        if (prodlike.parentNode.querySelector(".dash-like")) {
