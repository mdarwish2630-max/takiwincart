...
class XSS
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        // Previous: Simple regex removal (bypassable via encoding)
        // Fixed: Multi-pass deep sanitization with encoding normalization
        $input = $request->all();
    ...
    {
        $trimmed = trim($value);
        return ($trimmed[0] === '{' || $trimmed[0] === '[') && in_array(substr($trimmed, -1), ['}', ']']);
    }
