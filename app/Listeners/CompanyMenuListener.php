...
class CompanyMenuListener
{
    ...
    public function handle(CompanyMenuEvent $event): void
    {
        ...
        // [DIGITAL] Delivery Boy removed - not needed for digital products
        ...
        /** Products End */
        // [DIGITAL] Shipping section removed - not needed for digital products
        ...
        /**Support ticket End */        // [DIGITAL] POS removed - not needed for digital products
        /**CMS start */
        $menu->add([
            'title' => __('CMS'),
            'icon' => 'layout-cards',
