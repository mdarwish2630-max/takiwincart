...
class DedicatedSectionController extends Controller
{
    ...
    public function index()
    {
        ...
        if(\Auth::user()->isAbleTo('Manage LandingPage')){
            ...
            return view('landing-page::landingpage.dedicated.index', compact('settings','dedicated_card_details'));
    ...
    public function dedicated_card_create(){
        $settings = LandingPageSetting::settings();
        return view('landing-page::landingpage.dedicated.card_create');
    }
    ...
    public function dedicated_card_edit($key){
        ...
        return view('landing-page::landingpage.dedicated.card_edit', compact('dedicated_card','key'));
    }
