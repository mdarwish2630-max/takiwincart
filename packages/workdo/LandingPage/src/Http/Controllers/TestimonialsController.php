...
class TestimonialsController extends Controller
{
    ...
    public function index()
    {
        if(\Auth::user()->type == 'super admin'){
            ...
            return view('landing-page::landingpage.testimonials.index',compact('settings','testimonials'));
        }else{
    ...
    {
        return view('landing-page::landingpage.testimonials.create');
    }
    ...
    public function testimonials_store(Request $request){
        ...
        if( $request->testimonials_user_avtar){
            ...
            $datas['testimonials_user_avtar'] = $path['url'] ?? $testimonials_user_avtar;
        }
    ...
    public function testimonials_edit($key){
        ...
        return view('landing-page::landingpage.testimonials.edit', compact('testimonial','key'));
    }
    ...
    public function testimonials_update(Request $request, $key){
        ...
        if( $request->testimonials_user_avtar){
            ...
            $data[$key]['testimonials_user_avtar'] = $path['url'] ?? $testimonials_user_avtar;
        }
