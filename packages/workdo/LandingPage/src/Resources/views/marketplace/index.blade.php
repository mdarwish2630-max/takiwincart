@extends('landing-page::layouts.marketplace')
@php
...
<div class="wrapper">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            <div class="section-title">
                                <h2>{{ $marketplace['product_main_heading'] ?? $module->alias }}</h2>
                            </div>
                            <p>{!! $marketplace['product_main_description'] !!}</p>
                            @if ($marketplace['product_main_demo_link'] || $marketplace['product_main_demo_button_text'])
                            <div class="cart-view btn-group">
                                <a href="{{$marketplace['product_main_demo_link'] ?? '#' }}" class="link-btn">{{ $marketplace['product_main_demo_button_text'] ?? __('View Live Demo')}} <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="row row-gap padding-bottom ">
                                ...
                                <div class="col-lg-7 col-md-6 col-12">
                                    <div class="dash-theme-preview">
                                        <img src="{{ check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : (check_file($old_path."/image".$img.".png") ? get_file($old_path."/image".$img.".png") : get_file($old_path."/image2.png")) }}" alt="" class="inner-frame-img">
                                    </div>
                                </div>
                            </div>
                        @else
                            <div class="row row-gap  padding-bottom">
                                <div class="col-lg-7  col-md-6 col-12">
                                    <div class="dash-theme-preview">
                                        <img src="{{ check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : (check_file($old_path."/image".$img.".png") ? get_file($old_path."/image".$img.".png") : get_file($old_path."/image3.png")) }}" alt="" class="inner-frame-img">
                                    </div>
                                </div>
                                <div class="col-lg-5 col-md-6 col-12">
                                    <div class="abt-theme">
    ...
    @if ($marketplace['whychoose_sections_status'] == 'on')
        <section class="why-choose-section padding-top">
            <div class="container">
                <div class="section-title text-center">
                    <h2 class="text-white">{!! $marketplace['whychoose_heading'] !!}</h2>
                        ...
                        @endphp
                            <div class="screenshot-itm">
                                <div class="screenshot-image">
                                    <a href="{{ check_file($value['screenshots']) ? get_file($value['screenshots']) :(check_file($old_path."/image".$imageKey.".png") ? get_file($old_path."/image".$imageKey.".png") : get_file($old_path."/image{$imageKey}.png")) }}" target="_blank" class="img-zoom">
                                        <img src="{{ check_file($value['screenshots']) ? get_file($value['screenshots']) :(check_file($old_path."/image".$imageKey.".png") ? get_file($old_path."/image".$imageKey.".png") : get_file($old_path."/image{$imageKey}.png")) }}" alt="" class="inner-frame-img">
                                    </a>
                                </div>
                            </div>
                    @endforeach
                ...
                @if (count($modules) > 0)
                    <div class="row product-row">
                        @foreach ($modules as $module)
                            @if (!isset($module->display) || (isset($module->display) && $module->display == true))
                            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                                <div class="product-card-inner">
                                    <div class="product-img">
                                        <a href="{{ route('software.details',$module->alias) }}">
                                            <img src="{{ $module->image ?? 'assets/images/Custom-Fields.png'}}" alt="">
                                        </a>
                                    </div>
