        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::text('dedicated_theme_section_heading',null, ['class' => 'form-control ', 'placeholder' => __('Enter Heading'),'required'=>'required', 'id' => 'dedicated_theme_section_heading']) }}
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    {{ Form::label('dedicated_theme_section_image', __('Section Image'), ['class' => 'form-label']) }}
                    <input type="file" name="dedicated_theme_section_image" id="dedicated_theme_section_image" class="form-control" required>
                </div>
            </div>
            ...
            <div class="border" >
                ...
                <div id="add-cards1" class="border-bottom row py-2">
                    ...
                    <div class="col-md-2 d-flex text-center align-items-center">
                        <a href="#" id="delete-card1" class="card-delete btn btn-badge btn-danger btn-sm align-items-center bg-danger" title="{{__('Delete')}}" data-title="{{__('Delete')}}" data-original-title="{{__('Delete')}}">
