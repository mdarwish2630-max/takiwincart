        ...
        <div class="p-3 border-bottom accordion-header">
            <div class="row align-items-center">
                ...
                <div id="p1" class="col-auto text-end text-primary h3">
                    <a image-url="{{ get_file('packages/workdo/landing-page/src/Resources/assets/infoimages/dedicationsectiondetails.png') }}"
...
<div class="border">
    <div class="p-3 border-bottom accordion-header">
        <div class="row align-items-center">
            ...
            <div id="p1" class="col-auto text-end text-primary h3">
                <a image-url="{{ get_file('packages/workdo/landing-page/src/Resources/assets/infoimages/dedicatedsectioncards.png') }}" data-id="1"
                   data-url="{{ route('info.image.view',['landingpage','dedicated']) }}" class="view-images pt-2">
                    <i class="ti ti-info-circle pointer"></i>
                </a>
            </div>
            <div class="col-auto justify-content-end d-flex">
                <a href="javascript::void(0)" data-size="lg" data-url="{{ route('dedicated_card_create') }}" data-ajax-popup="true"  data-bs-toggle="tooltip" data-title="{{__('Create New Card')}}" title="{{__('Create')}}"  class="btn btn-sm btn-primary">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="d-flex gap-1 justify-content-end">
                                        <a href="#" class=" btn btn-sm btn-info" data-url="{{ route('dedicated_card_edit',$key) }}" data-ajax-popup="true" data-title="{{__('Edit Card Detail')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                                            <i class="ti ti-pencil"></i>
                                        </a>
                                        {!! Form::open(['method' => 'GET', 'route' => ['dedicated_card_delete', $key],'id'=>'delete-form-'.$key]) !!}
                                            <a href="#" class="btn btn-sm btn-danger show_confirm" data-bs-toggle="tooltip" title="{{__('Delete')}}" data-original-title="{{__('Delete')}}" data-confirm-yes="{{ 'delete-form-'.$key}}">
