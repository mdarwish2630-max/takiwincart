        ...
        <div class="p-3 border-bottom accordion-header">
            <div class="row align-items-center">
                ...
                <div id="p1" class="col-auto text-end text-primary h3">
                    <a image-url="{{ get_file('packages/workdo/landing-page/src/Resources/assets/infoimages/buildtechsectiondetails.png') }}"
...
<div class="border">
    <div class="p-3 border-bottom accordion-header" >
        <div class="row align-items-center">
            ...
            <div id="p1" class="col-auto text-end text-primary h3">
                <a image-url="{{ get_file('packages/workdo/landing-page/src/Resources/assets/infoimages/buildtechsectioncards.png') }}" data-id="1"
                   data-url="{{ route('info.image.view',['landingpage','buildtech']) }}" class="view-images pt-2">
                    <i class="ti ti-info-circle pointer"></i>
                </a>
            </div>
