    ...
    <a href="{{ route('seo.page') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'seo.page') ? ' active' : '' }}">{{ __('SEO') }} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

   @stack('campaignsTabForm')
