...
<input type="hidden" name="customer_id" value="{{ auth('customers')->user() ? auth('customers')->user()->id : 0 }}">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12">
            <div class="form-group list_height_css">
                ...
                <div class="state">
                    {!! Form::select('state', $state_option ?? [], null, [
        ...
        <div class="col-md-6 col-12">
            <div class="form-group list_height_css">
                ...
                <div class="city" >
                    {!! Form::select('city',  $city_option ?? [], null, [
