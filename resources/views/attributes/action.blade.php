...
<button class="btn btn-sm btn-info" data-url="{{ route('product-attributes.edit', $attribute->id) }}"
    data-size="md" data-ajax-popup="true" data-title="{{ __('Edit Attribute') }}" data-bs-toggle="tooltip"
    title="{{ __('Edit') }}">
