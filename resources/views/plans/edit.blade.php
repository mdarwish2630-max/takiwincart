...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item mb-2" aria-current="page">{{ __('Edit') }}</li>
@endsection
...
<div class="card">
    <div class="card-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap g-2">
            <h3 class="h4 m-0">{{ __('Edit Plan') }}</h3>
            <div class="d-flex align-items-center justify-content-end flex-wrap g-2">
                ...
                <a href="#" class="btn btn-primary btn-badge me-2 ai-btn" data-size="lg" data-ajax-popup-over="true" data-url="{{ route('generate',['plan']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}" data-title="{{ __('Generate Content With AI') }}">
                    <i class="fas fa-robot"></i> {{ __('Generate with AI') }}
                </a>
                @endif
                <a href="{{ route('plan.index') }}"class="btn btn-badge btn-secondary ai-btn">{{__('Back')}} </a>
            </div>
        </div>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
                        <div class="custom-control form-switch pt-2 ps-0 gap-1 select-swich d-flex align-items-center">
                            <input type="checkbox" class="form-check-input" name="enable_domain" id="enable_domain"  {{ $plan['enable_domain'] == 'on' ? 'checked=checked' : '' }}>
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
                        <div class="custom-control form-switch pt-2 ps-0 gap-1 select-swich d-flex align-items-center">
                            <input type="checkbox" class="form-check-input" name="enable_subdomain" id="enable_subdomain"  {{ $plan['enable_subdomain'] == 'on' ? 'checked=checked' : '' }}>
                            <label class="custom-control-label form-check-label"
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
                        <div class="custom-control form-switch pt-2 ps-0 gap-1 select-swich d-flex align-items-center">
                            <input type="checkbox" class="form-check-input" name="enable_tax" id="enable_tax" {{ $plan['enable_tax'] == 'on' ? 'checked=checked' : '' }}>
                        <label class="custom-control-label form-check-label"
                    ...
                    <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="form-group gap-1 d-flex align-items-center trial-switch">
                            ...
                            <div class="form-check form-switch custom-switch-v1 float-end">
                                <input type="checkbox" name="trial" class="form-check-input input-primary pointer" value="1" id="trial" {{ ($plan['trial'] == 1 || $plan['trial'] == 'on') ? 'checked=checked' : '' }}>
                                <label class="form-check-label" for="trial"></label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="all-plans">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="col-md-2">
                                <input type="text" id="addon-search" placeholder="{{__('Search Modules')}}" class="form-control btn-badge">
                            </div>
                        </div>
                        <hr>
                                                    ...
                                                    <div class="card-body p-3 border border-primary">
                                                        <div class="gap-2 d-flex align-items-center justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                <div class="p-3 border border-primary img-checkbox" data-checkbox="modules_{{ $module->name }}">
                                                                    <div class="theme-avtar">
                                                                        <img src="{{ $module->image }}{{ '?' . time() }}" alt="{{ $module->name }}" class="img-user" style="max-width: 100%">
                                                                    </div>
                                                                </div>
                                                                <div class="ms-3">
                                                                    <label for="modules_{{ $module->name }}">
                                                                        <h5 class="mb-0 pointer">{{ ucwords($module->alias) }}</h5>
                                                                    </label>
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input modules" name="modules[]" value="{{ $module->name }}" id="modules_{{ $module->name }}" type="checkbox"  {{in_array($module->name,explode(',',$plan->modules)) == true ? 'checked' : ''  }}>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card p-5">
                                            <div class="d-flex justify-content-center">
                                                <div class="ms-3 text-center">
                                                    ...
                                                    <p class="text-muted">{{ __('Click ') }}<a href="{{ route('module.index') }}">{{ __('here') }}</a> {{ __('To Activate Add-on') }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="horizontal mt-3">
                            <div class="verticals twelve">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" id="theme-search" placeholder="{{__('Search Themes')}}" class="form-control btn-badge mt-3">
                                    </div>
                                </div>
                                <hr>
                ...
                <div class="form-group col-12 d-flex justify-content-end form-label">
                    <a href="{{ route('plan.index') }}"class="btn btn-secondary">{{__('Back')}} </a>
