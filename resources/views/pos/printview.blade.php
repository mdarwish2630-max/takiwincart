@php
    ...
    $Tax =  \App\Models\Tax::where('store_id', getCurrentStore())->first();
@endphp
<div class="pt-0 pb-3 modal-body pos-module" id="printarea" >
    <table class="table pos-module-tbl">
        <tbody>
            <div class="text-center ">
                <h3>{{ $details['store']['name'] ?? $details['user']['name'] }}</h3>
            </div>
            <div class="text-left">
...
<script>
    $("#print").click(function () {
        ...
        $('.row').addClass('d-none');
        $('.dash-header').addClass('d-none');
        $('.dash-footer').addClass('d-none');
        ...
        $('.dash-header').removeClass('d-none');
        $('.dash-footer').removeClass('d-none');
    });
</script>
