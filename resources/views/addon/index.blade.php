            ...
            <div class="card">
                <div class="card-body package-card-inner  d-flex align-items-center">
                    ...
                    <div class="price text-end">
                        <a class="btn btn-primary" href="#" target="new">
                            {{ __('Themes Addon') }}
                        </a>
                    </div>
                </div>
                        ...
                        <div class="product-content">
                            <div class="product-content-top">
                                <small class="text-muted">
                                    @if($value->status == '1')
                                        <span class="badges bg-success">{{__('Enable')}}</span>
                                    @else
                                        <span class="badges bg-danger">{{__('Disable')}}</span>
                                    @endif
                                </small>
                            ...
                            <div class="product-content">
                                <div class="product-content-top">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-2">
                                        ...
                                        @if(!in_array($value[0],['stylique', 'greentic', 'techzonix']))
                                               <a href="" target="_new" class="btn btn-outline-primary btn-sm" title="Free Download">{{ __('Free Download') }}
