<span class="d-flex gap-1 justify-content-end">
    <button class="btn btn-sm btn-badge btn-info" data-url="{{ route('city.edit', $city['id']) }}" data-size="md" data-ajax-popup="true" data-title="{{ __('Edit City') }}" data-bs-toggle="tooltip" title="{{ __('Edit') }}">
