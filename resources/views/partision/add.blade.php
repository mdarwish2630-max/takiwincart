{{-- <div class="col-full">
    <p class="text-center"> <strong></strong>  Buy now and get  <b><span style="color:#F4B41A"> 10 Additional themes</span></b>  for free. <a href="#" target="_blank">{{ env('APP_NAME', 'TakiwinCart') }}</a> </p>
</div> --}}
<div class="col-full">
    {{--<a class="quotes" href="#" target="_blank">
