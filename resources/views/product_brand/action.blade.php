...
<button class="btn btn-sm btn-info" data-url="{{ route('product-brand.edit', $brand->id) }}" data-size="md"
    data-ajax-popup="true" data-title="{{ __('Edit Brand') }}" data-bs-toggle="tooltip"
    title="{{ __('Edit') }}">
